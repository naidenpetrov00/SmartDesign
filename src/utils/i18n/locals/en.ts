export const en = {
  ...
  phrases: {
    apartmentRenovations:
      "Research – Defining the scope and purpose of the assignment",
    homeTransformations:
      "Concept design – Functional layout and design concept",
    qualityRepairs:
      "Working project – Detailed drawings, documentation, and implementation planning",
    modernUpgrades:
      "Implementation – Author’s supervision and coordination of the realization",
  },
  steps: {
