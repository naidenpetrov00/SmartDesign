export const tr = {
  ...
  phrases: {
    apartmentRenovations:
      "Araştırma – Projenin kapsamının ve amacının belirlenmesi",
    homeTransformations:
      "Konsept proje – Fonksiyonel yerleşim ve tasarım konsepti",
    qualityRepairs:
      "Uygulama projesi – Detaylı çizimler, dokümantasyon ve uygulama planlaması",
    modernUpgrades: "Uygulama – Yazar gözetimi ve uygulama koordinasyonu",
  },
  steps: {
    askAI: "AI’mize bilgi için sorular sorun",
    contactUs: "Bize ulaşın.",
    inspection: "Uzmanımız tarafından ÜCRETSİZ inceleme.",
    offer: "Teklifimizi sunuyoruz.",
  ...
  buttons: {
    contacts: "İLETİŞİM",
    checkMore: "DAHA FAZLASINI GÖR",
  },
  footer: {
    contactUs: "Bize Ulaşın",
    reachOut:
      "Bir ziyaret planlamak için bizimle iletişime geçin. Sürecimizdeki ilk adım!",
